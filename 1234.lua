        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                function Window:SetTransparency()
                    local MainTransparency = Library.Flags["MainWindowTransparency"]
                    local LeftTransparency = Library.Flags["LeftTabsTransparency"]
                    local ContentTransparency = Library.Flags["ContentTransparency"]

                    if MainTransparency == nil or LeftTransparency == nil or ContentTransparency == nil then
                        local Legacy = Library.Flags["BackgroundTransparency"]
                        if Legacy ~= nil then
                            MainTransparency = MainTransparency == nil and Legacy or MainTransparency
                            LeftTransparency = LeftTransparency == nil and Legacy or LeftTransparency
                            ContentTransparency = ContentTransparency == nil and Legacy or ContentTransparency
                        end
                    end

                    if MainTransparency ~= nil and Items["MainFrame"] then
                        Items["MainFrame"].Instance.BackgroundTransparency = tonumber(MainTransparency)
                    end

                    if LeftTransparency ~= nil and Items["LeftTabs"] then
                        Items["LeftTabs"].Instance.BackgroundTransparency = tonumber(LeftTransparency)
                    end

                    if ContentTransparency ~= nil and Items["Content"] then
                        Items["Content"].Instance.BackgroundTransparency = tonumber(ContentTransparency)
                    end

                    if IsMobile and Items["FloatingButton"] and LeftTransparency ~= nil then
                        Items["FloatingButton"].Instance.BackgroundTransparency = tonumber(LeftTransparency)
                    end

                    for Key, Value in Items do 
                        if type(Key) == "string" and Key:find("___") and Value and Value.Instance then
                            Value.Instance.BackgroundTransparency = tonumber(LeftTransparency or MainTransparency or ContentTransparency or 0)
                        end
                    end
                end
                ...
                Settings:Slider({
                    ...
                    Callback = function(Value)
                        Items["LeftTabs"].Instance.Size = UDim2New(0, Value, 1, 0)
                    end
                })
                ...
                Settings:Slider({
                    ...
                    Flag = "TopTabSize",
                    Callback = function(Value)
                        Items["Content"].Instance.Position = UDim2New(0, 0, 0, Value)
                        Items["Content"].Instance.Size = UDim2New(1, 0, 1, -Value)
                    end
                })
                ...
                Settings:Slider({
                    Name = "Main window transparency",
                    Default = 0.12,
                    Decimals = 0.01,
                    Max = 1,
                    Min = 0,
                    Suffix = "%",
                    Flag = "MainWindowTransparency",
                    Callback = function(Value)
                ...
                Settings:Slider({
                    Name = "Left tab transparency",
                    Default = 0.12,
                    Decimals = 0.01,
                    Max = 1,
                    Min = 0,
                    Suffix = "%",
                    Flag = "LeftTabsTransparency",
                    Callback = function(Value)
                        Window:SetTransparency()
                    end
                })
